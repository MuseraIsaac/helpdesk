...
export const updateProblemSchema = z
  .object({
    ...
    pirSummary: z.string().max(10000).nullable(),
    pirOutcome: z.enum(["successful", "partially_successful", "unsuccessful"]).nullable(),
    pirActionItems: z.string().max(10000).nullable(),
    pirCompletedAt: z.string().datetime().nullable(),
