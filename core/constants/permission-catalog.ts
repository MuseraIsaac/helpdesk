...
export const PERMISSION_CATALOG: PermissionMeta[] = [
  ...
  // ── Contacts ───────────────────────────────────────────────────────────────
  { key: "contacts.view",
    label: "View & manage contacts",
    description: "Browse customers and organizations, plus edit if you have other write permissions.",
  ...
  { key: "settings.view",
    ...
    description: "See and open the Settings (gear) page in the sidebar.",
