...
const DASHBOARD_TEMPLATES = [
  ...
  },
  {
    ...
    previewRows: [
      ...
      [{ x:0, w:6,  label:"Per Day",     color:"#6366F1" }, { x:6, w:6, label:"Leaderboard", color:"#818CF8" }],
    ],
    widgets: [
      { id: "volume",           visible: true, order: 0, x: 0,  y: 0,  w: 12, h: 2 },
      { id: "performance",      visible: true, order: 1, x: 0,  y: 2,  w: 12, h: 2 },
      { id: "sla_by_dimension", visible: true, order: 2, x: 0,  y: 4,  w: 4,  h: 5 },
      { id: "fcr_rate",         visible: true, order: 3, x: 4,  y: 4,  w: 4,  h: 5 },
      { id: "csat",             visible: true, order: 4, x: 8,  y: 4,  w: 4,  h: 5 },
      { id: "tickets_per_day",  visible: true, order: 5, x: 0,  y: 9,  w: 6,  h: 4 },
      { id: "agent_leaderboard",visible: true, order: 6, x: 6,  y: 9,  w: 6,  h: 4 },
      { id: "breakdowns",       visible: true, order: 7, x: 0,  y: 13, w: 12, h: 5 },
    ],
    config: { period: 30, density: "compact" },
  },
];
